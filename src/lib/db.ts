...
export async function insertAttempt(a: NewAttempt): Promise<void> {
  ...
  await ensureSchema();
  await sql`INSERT INTO attempts (profile, type_id, topic_id, level, correct, hints, reveals, wrong_lines, duration_sec, lines, prompt, mistakes)
    VALUES (${a.profile}, ${a.type_id}, ${a.topic_id}, ${a.level}, ${a.correct}, ${a.hints}, ${a.reveals}, ${a.wrong_lines}, ${a.duration_sec}, ${JSON.stringify(a.lines)}, ${a.prompt}, ${JSON.stringify(a.mistakes)})`;
}
